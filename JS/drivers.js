...
var vm = function () {
    ...
    //---Variáveis locais
    var self = this;
    self.baseUri = ko.observable('http://192.168.160.58/Formula1/api/Drivers/Drivers');
...
$(document).ready(function () {
    ...
    const api_url = "http://192.168.160.58/Formula1/api/Search/Drivers";
    ...
    $("#procura").autocomplete({
        ...
        select: function (event, ui) {
            ...
            window.location.href = "./driverDetails.html?id=" + ui.item.value;
